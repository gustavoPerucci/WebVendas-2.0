    ...
    function buscarClientes(status, nome, id_cliente) {
        ...
        $.ajax({
            ...
            type : "GET",
            data : { status : status, nome: nome, id_cliente: id_cliente, pessoa: 'JURIDICA' },
            success : function(json) {
                    ...
                    '<tr style="white-space: nowrap;">'+
                        ...
                        '<th>Razão social</th>'+
                        '<th data-hide="phone,tablet">Nome fantasia</th>'+
                        '<th data-hide="phone,tablet">CNPJ</th>'+
                        '<th data-hide="phone,tablet">Status</th>'+
                        '<th data-hide="phone,tablet">Contato</th>'+
                        '<th data-hide="phone,tablet">Telefone</th>'+
                        '<th data-hide="phone,tablet">Celular</th>'+
                        '<th data-hide="phone,tablet">E-mail</th>'+
                        '<th data-hide="phone,tablet">Insc. estadual</th>'+
                        '<th data-hide="phone,tablet">Insc. municipal</th>'+
                         '<th data-hide="phone,tablet">Data fundação</th>'+
                ...
                for(var i=0;json.length>i;i++){
                    ...
                    '<td class="'+json[i].classe+'">'+
                        '<div class="col-xs-6 col-sm-6 text-left">'+
                            '<div class="txt-color-white inline-block">'+
                                '<div class="btn-group">'+
                                    '<a style="cursor:pointer;" class="dropdown-toggle" data-toggle="dropdown">'+json[i].nome_razao_social+'</a>'+
                                    '<ul class="dropdown-menu pull-left text-left" style="">'+
                                        '<li class="text-center"><span style="margin-left:10px;margin-right:10px;font-size:20px;color:orange;">'+json[i].nome_razao_social+'</span></li>'+
                                        '<li class="divider"></li>'+
                                        '<li>'+
                        ...
                        '</div>'+
                    '</td>'+
                    '<td class="'+json[i].classe+'">'+json[i].nome_fantasia+'</td>'+
                    ...
                    '<td class="'+json[i].classe+'" style="white-space: nowrap;">'+
                            ...
                            '<div class="txt-color-white inline-block">'+
                                '<div class="btn-group">'+
                                    ...
                                    '<ul class="dropdown-menu pull-left text-left" style="">'+
                                        ...
                                        '<li class="divider"></li>'+
                                        '<li>'+
                                            '<a style="cursor:pointer;" id="inadipente-cliente-'+json[i].id+'">DEIXAR INADIPLENTE</a>'+
                                        '</li>'+
                                        '<li class="divider"></li>'+
                                        '<li>'+
                        ...
                        '</div>'+
                    '</td>'+
                    '<td class="'+json[i].classe+'">'+json[i].contato+'</td>'+
                    ...
                    '<td class="'+json[i].classe+'">'+json[i].inscricao_municipal+'</td>'+
...
function buscarCliente(id_cliente) {
    $.ajax({
        ...
        type : "GET",
        data : { id : id_cliente, pessoa: 'JURIDICA' },
