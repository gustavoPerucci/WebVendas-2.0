    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nome_razao_social', models.CharField(max_length=30, verbose_name=b'Nome')),
                ...
                ('status', models.CharField(default=b'ATIVO', max_length=10, verbose_name=b'St\xc3\xa1tus')),
                ...
                ('data_nascimento_fundacao', models.DateField(verbose_name=b'Data nascimento')),
                ...
                ('nome_fantasia', models.CharField(blank=True, max_length=50, verbose_name=b'Nome fantasia')),
