...
class Clientes(models.Model):
    nome_razao_social = models.CharField('Nome', max_length=50, blank=False)
    ...
    status = models.CharField('Státus', max_length=20, default='ATIVO', blank=False,)
    ...
    data_nascimento_fundacao = models.DateField('Data nascimento', blank=True, null=True)
    ...
    sobre_nome = models.CharField('Sobre nome', max_length=50, blank=True)
